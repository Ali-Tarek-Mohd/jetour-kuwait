...
export const modelCatalogue: ModelCatalogueEntry[] = [
  ...
  },
  {
    name: "X50",
    slug: "x50",
    image: "/images/vehicles/x50/colors/black.webp",
    imageAlt: "Jetour X50 in Black",
    availability: "details-coming-soon",
    detailStatus: "coming-soon",
    colorControlVerb: "View",
    catalogueImageScale: 1.5,
    catalogueImageTransformOrigin: "50% 48%",
    colors: [
      { name: "Black", swatch: "#17191a", image: "/images/vehicles/x50/colors/black.webp", available: true, alt: "Jetour X50 in Black", studioBackground: { base: "#111517", centralGlow: "rgba(72,81,86,.54)", highlight: "rgba(157,166,171,.21)", floorGlow: "rgba(94,103,108,.17)", vignetteStrength: .69 }, foregroundTone: "light" },
      { name: "White", swatch: "#ecece7", image: "/images/vehicles/x50/colors/white.webp", available: true, alt: "Jetour X50 in White", studioBackground: { base: "#23272a", centralGlow: "rgba(178,188,190,.52)", highlight: "rgba(244,247,243,.26)", floorGlow: "rgba(194,203,203,.18)", vignetteStrength: .7 }, foregroundTone: "light" },
      { name: "Dark Grey", swatch: "#4b5053", image: "/images/vehicles/x50/colors/dark-grey.webp", available: true, alt: "Jetour X50 in Dark Grey", studioBackground: { base: "#171c1f", centralGlow: "rgba(87,99,106,.53)", highlight: "rgba(166,177,182,.2)", floorGlow: "rgba(94,105,111,.16)", vignetteStrength: .71 }, foregroundTone: "light" },
      { name: "Light Blue", swatch: "#8eb5c5", image: "/images/vehicles/x50/colors/light-blue.webp", available: true, alt: "Jetour X50 in Light Blue", studioBackground: { base: "#152630", centralGlow: "rgba(91,148,175,.55)", highlight: "rgba(190,220,231,.23)", floorGlow: "rgba(92,137,155,.18)", vignetteStrength: .7 }, foregroundTone: "light" },
      { name: "Silver", swatch: "#a5abad", image: "/images/vehicles/x50/colors/silver.webp", available: true, alt: "Jetour X50 in Silver", studioBackground: { base: "#20272b", centralGlow: "rgba(130,148,157,.54)", highlight: "rgba(207,219,222,.24)", floorGlow: "rgba(150,166,173,.17)", vignetteStrength: .69 }, foregroundTone: "light" },
    ],
  },
  {
    name: "X70 FL",
    slug: "x70-fl",
    image: "/images/vehicles/x70-fl/colors/black.webp",
    imageAlt: "Jetour X70 FL in Black",
    availability: "details-coming-soon",
    detailStatus: "coming-soon",
    colorControlVerb: "View",
    catalogueImageScale: 1.35,
    catalogueImageTransformOrigin: "50% 46%",
    colors: [
      { name: "Black", swatch: "#17191a", image: "/images/vehicles/x70-fl/colors/black.webp", available: true, alt: "Jetour X70 FL in Black", studioBackground: { base: "#111517", centralGlow: "rgba(70,79,84,.54)", highlight: "rgba(154,164,169,.2)", floorGlow: "rgba(91,101,106,.17)", vignetteStrength: .7 }, foregroundTone: "light" },
      { name: "Silver", swatch: "#a8adaf", image: "/images/vehicles/x70-fl/colors/silver.webp", available: true, alt: "Jetour X70 FL in Silver", studioBackground: { base: "#20272b", centralGlow: "rgba(130,149,158,.53)", highlight: "rgba(211,222,225,.24)", floorGlow: "rgba(148,165,172,.17)", vignetteStrength: .69 }, foregroundTone: "light" },
      { name: "Grey", swatch: "#555b5f", image: "/images/vehicles/x70-fl/colors/grey.webp", available: true, alt: "Jetour X70 FL in Grey", studioBackground: { base: "#171c1f", centralGlow: "rgba(82,93,99,.52)", highlight: "rgba(160,171,176,.2)", floorGlow: "rgba(89,100,105,.16)", vignetteStrength: .71 }, foregroundTone: "light" },
